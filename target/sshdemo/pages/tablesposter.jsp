                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <c:forEach items="${posterList}" var="posterentry" varStatus="status">
                                    <tr>

                                    <td > ${posterentry.posterLoc}</td>
                                        <td >${posterentry.goodsid}</td>
                                    <td >
                                        <img src="${posterentry.posterPath}"  style="width: 150px;height: 58px" />
                                    </td>

                                    <td colspan="5">
                                        <a href="/poster_op_tochange?idposterTable=${posterentry.idposterTable}"  class="" style="margin-left: 100px">更换</a>
                                    </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
