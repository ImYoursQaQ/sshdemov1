            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        海报编号：${currentposter.idposterTable}
                    </div>
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                        <div class="col-lg-6">
                            <form name="form2" id="ff2" method="post" action="poster_op_change" enctype="multipart/form-data">
                                <div class="form-group">
                                    <span>当前位置：${currentposter.posterLoc}</span>
                                </div>

                                <div class="form-group">
                                    <span>当前海报商品：${currentposter.goodsid}</span>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="输入新的商品编号 :" name="posterGoodsid"  required>
                                </div>

                                <div class="form-group">
                                    <span>当前海报：<img src="${currentposter.posterPath}"  style="width: 300px;height: 116px" />
                                    </span>
                                </div>
                                ...
                                <div class="form-group">
                                    <label >选择新的海报</label>
                                    <div class="">
                                        <img  id="img0" style="width: 300px;height: 160px" src="">
