                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <c:forEach items="${goodsList}" var="phoneentry" varStatus="status">
                                    <tr>
                                    <td >${phoneentry.goodsid}</td>
                                    <td > ${phoneentry.title}</td>
                                    <td ><img src="${phoneentry.mainpic}"  style="width: 58px;height: 58px" /></td>
                                    <td> ${phoneentry.price}</td>
                                        <td> ${phoneentry.storeNumber}</td>
                                        <td colspan="5">

                                            <%--<a href="/phone_op_addStore?goodsid=${phoneentry.goodsid}&"  class="" style="margin-left: 100px"
                                               onclick="return myclick();">库存增加</a>--%>
                                            <div class="col-md-5">
                                                <form method="post"
                                                      action="phone_op_addStoreNumber?goodsid=${phoneentry.goodsid}">
                                                    <input type="text" name="storenumber1" style="width: 50px">
                                                    <input type="submit" value="库存增加">

                                                </form>
                                            </div>
                                            <div class="col-md-3">
                                                <%--<a href="/phone_op_toscore?goodsid=${phoneentry.goodsid}" class=""
                                                   style="">评分</a>--%>
                                                <a href="/phone_op_toscore?goodsid=${phoneentry.goodsid}" class=""
                                                   style="">评分维护</a>
                                            </div>
