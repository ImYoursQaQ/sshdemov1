                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            用户编号:${userforadmin.userid}
                        </div>
                        <!-- /.panel-heading -->
                        <form name="form2" id="ff2" method="post" action="user_op_updata?userid=${userforadmin.userid}">
                            <div class="form-group">
                                <input type="text" class="form-control"  value="${userforadmin.username}" name="user.username" required >
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" value="${userforadmin.phone} "  name="user.phone" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" value="${userforadmin.email} "  name="user.email" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" value="${userforadmin.address} "  name="user.address" required>
                            </div>
