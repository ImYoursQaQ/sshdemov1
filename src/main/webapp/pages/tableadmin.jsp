...
<head>
    ...
    <script type="text/javascript">
       ...
       /* function init() {
            ...
            var myName="${sessionScope.errorMessage}";

            if(!myName.length==0&&flag==1){
                alert(myName);
                flag=-1*flag;
            }
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <c:forEach items="${userList}" var="userentry" varStatus="status">
                                    <tr>
                                    <td >${userentry.userid}</td>
                                    <td > ${userentry.username}</td>
                                    <td >${userentry.phone}</td>

                                    <td> ${userentry.address}</td>
                                    <td colspan="5">
                                        <a href="/user_op_userdetail?userid=${userentry.userid}"  class="" style="margin-left: 100px">修改</a>
                                        <a href="/user_op_delete?userid=${userentry.userid}"  class="" style="margin-left: 100px">删除</a>
