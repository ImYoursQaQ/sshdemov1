                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <c:forEach items="${orderlist}" var="orderentry" varStatus="status">
                                    ...
                                    <td > ${orderentry.creattime}</td>
                                        <td >${orderentry.orderid}</td>
                                    <td >${orderentry.userid}</td>
                                    <td>
                                    ...
                                    <td colspan="5">
                                        <a href="/order_goods?orderid=${orderentry.orderid}"  class="" style="margin-left: 100px">订单详情</a>
                                        <c:if test="${orderentry.orderstatus eq 1}">
                                            <a href="/order_op_send?orderid=${orderentry.orderid}"  class="" style="margin-left: 100px">立即发货</a>
                                        </c:if>
                                    </td>
                                    </tr>
                                </c:forEach>
